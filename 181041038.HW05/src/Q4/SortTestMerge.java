...
public class SortTestMerge extends SortTestAbstract {


    public SortTestMerge(Integer[] unorderednumbers, boolean printnumbers, boolean printstatus) {
    ...
    public long testandgetElapsedtime() {
        ...
        if ( isPrintstatus() ) {
            System.out.println("Merge Sort Test for  " + numbers.length + "  number");
        }
        if (isPrintnumbers()) {
        ...
        // Mergesort sınıfının sort metodu ile sayılar sıralanıyor
